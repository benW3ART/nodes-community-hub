# NODES Community Hub — Claude Code Instructions
## Powered by Genius Team v11.0 (CLI Mode)

> ⚠️ **MANDATORY**: Read `GENIUS_GUARD.md` before ANY action.
> Read `.genius/memory/BRIEFING.md` at the start of every session.

**Project:** NODES Community Hub — NFT Tools for Nodes on Base  
**Stack:** Next.js 15 + wagmi + RainbowKit + Tailwind CSS 4  
**Deploy:** Railway → `nodes-community-hub-production.up.railway.app`  
**Mode:** CLI (Terminal)  
