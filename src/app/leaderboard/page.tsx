        ...
        {isLoading ? (
          ...
          <>
              ...
              <div className="card bg-gradient-to-br from-purple-500/10 to-transparent border-purple-500/30">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold">{data.stats.totalSupply.toLocaleString()}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="card bg-gradient-to-br from-blue-500/10 to-transparent border-blue-500/30">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold">{data.stats.uniqueHolders.toLocaleString()}</p>
                  </div>
                </div>
              </div>
              
              <div className="card bg-gradient-to-br from-pink-500/10 to-transparent border-pink-500/30">
                <div className="flex items-center gap-3">
                  <div className="p-3 bg-pink-500/20 rounded-xl">
                    <Sparkles className="w-6 h-6 text-pink-400" />
                  </div>
                  <div>
                    <p className="text-sm text-gray-400">Full Set Holders</p>
                    <p className="text-2xl font-bold">{data.stats.fullSetCount}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {address && (
              <div className="mb-6">
                {activeTab === 'collectors' && isUserInList(data.topCollectors) && (
                  <div className="card bg-gradient-to-r from-purple-500/20 to-pink-500/20 border-purple-500/30">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span>in Top Collectors!</span>
                      </div>
                    </div>
                  </div>
                )}
                {activeTab === 'fullsets' && isUserInList(data.fullSetHolders) && (
                  <div className="card bg-gradient-to-r from-pink-500/20 to-purple-500/20 border-pink-500/30">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span>among Full Set Holders!</span>
                      </div>
                    </div>
                  </div>
                )}
              ...
              {activeTab === 'collectors' ? (
                <div className="space-y-2">
                  <div className="grid grid-cols-12 gap-4 px-4 py-2 text-sm text-gray-400 border-b border-gray-800">
                    ...
                    <div className="col-span-3 text-right">NODES Owned</div>
                  </div>
                      ...
                      >
                        ...
                        <div className="col-span-8 flex items-center gap-2">
                          <a
                            ...
                            className="font-mono text-sm hover:text-purple-400 transition-colors flex items-center gap-1"
                          >
                            {collector.displayAddress}
                            <ExternalLink className="w-3 h-3 opacity-50" />
                          </a>
                          {isUser && (
                            <span className="badge-purple text-xs">You</span>
                          )}
                        </div>
                ...
                <div className="space-y-2">
                  <div className="grid grid-cols-12 gap-4 px-4 py-2 text-sm text-gray-400 border-b border-gray-800">
                    <div className="col-span-1">Rank</div>
                    <div className="col-span-8">Address</div>
                    <div className="col-span-3 text-right">Full Sets</div>
                  </div>
                        ...
                        >
                          ...
                          <div className="col-span-8 flex items-center gap-2">
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="font-mono text-sm hover:text-pink-400 transition-colors flex items-center gap-1"
                            >
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              Data refreshes every 5 minutes. Rankings based on on-chain data from Alchemy.
            </p>
          </>
        ) : null}
      </main>
